...
const checkCentury = (birthDate) => birthDate > 1900 && birthDate < 2001;

const checkNation = (nationality) => nationality === 'Australian';

const filterPeople = (people) => people.filter(({bornIn, nationality}) => 
  checkCentury(bornIn) && checkNation(nationality)
);
